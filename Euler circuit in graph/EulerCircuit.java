...
int counter=0;
    ...
    if(map.get("even")==4){System.out.print("Euler circuit exist is the graph");} //all vertex have even degree
    else{System.out.print("Euler circuit not exist is the graph");}
    ...
    public static void main(String[] args) {
        EulerCircuit ep=new EulerCircuit();
